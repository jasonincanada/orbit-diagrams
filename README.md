...
The functor and monad instances for `s ->` are elegantly rendered in orbit diagram notation.  Here is the functor instance for `s ->`, and both `bind` and `join` instances for the `s ->` monad:
...
**Lenses:**
  ...
  - [Symmetric concrete lenses](https://raw.githubusercontent.com/jasonincanada/orbit-diagrams/main/diagrams/profunctors-symmetric-lens.png) (derivation due to [Boisseau/Gibbons](https://dl.acm.org/doi/10.1145/3236779))
